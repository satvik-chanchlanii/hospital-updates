...
import java.io.*;
import java.util.*;
public class HospitalPatientsView extends HttpServlet
{
...
pw.println("");
pw.println("<tr>");
pw.println("<th colspan='3' style='text-align:right;padding:2px'>");
pw.println("</th>");
pw.println("</tr>");
pw.println("            <tr class='table'>");
pw.println("                <th>S.No.</th>");
pw.println("                <th style='text-align:center'>Hospital</th>");
pw.println("                <th>Patients</th>");
pw.println("            </tr>");
int x;
int hospitalNumber;
String hospitalName;
...
pw.println("<th style='text-align:center;color:red'>"+hospitalName+"</th>");
pw.println("                <th> <a href='/minor/patientsView?hospitalNumber="+hospitalNumber+"''>View Patients</a></th>");
pw.println("</tr>");
}
pw.println("        </table>");
pw.println("    </div>");
