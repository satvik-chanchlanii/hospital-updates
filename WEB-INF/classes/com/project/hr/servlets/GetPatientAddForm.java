...
pw.println("if(registrationAmount.value<3000)");
pw.println("{");
pw.println("registrationAmountErrorSection.innerHTML='Registration Amount 3000 required';");
pw.println("valid=false;");
...
pw.println("<td><input type='text' id='registrationAmount' name='registrationAmount' maxlength='4' size='14'>");
...
pw.println("<td><input type='text' id='aadharCardNumber' name='aadharCardNumber' maxlength='12' size='36'<br>");
