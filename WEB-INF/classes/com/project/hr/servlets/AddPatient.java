...
if(isVaccinated==null) isVaccinated="N";
Date dateOfBooking=sdf.parse(request.getParameter("dateOfBooking"));
BigDecimal registrationAmount=new BigDecimal(request.getParameter("registrationAmount"));
...
try
{
boolean hospitalCodeExists=hospitalDAO.hospitalNumberExists(hospitalCode);
boolean aadharCardNumberExists=patientDAO.aadharCardNumberExists(aadharCardNumber);
if(hospitalCodeExists==false || aadharCardNumberExists==true)
{
...
pw.println("}");
pw.println("}");
pw.println("if(registrationAmount<3000)");
pw.println("{");
pw.println("registrationAmountErrorSection.innerHTML='Registration Amount should not be less than 3000';");
pw.println("valid=false;");
pw.println("if(firstInvalidComponent==null) firstInvalidComponent=frm.registrationAmount;");
pw.println("}");
...
if(hospitalNumber!=hospitalCode)
{
pw.println("<option value='"+hospitalNumber+"'>"+hospitalName+"</option>");
}
else
{
pw.println("<option selected value='"+hospitalNumber+"'>"+hospitalName+"</option>");
}
}
pw.println("</select>");
if(hospitalCodeExists==false)
{
pw.println("<span id='hospitalCodeErrorSection' style='color: red'> Invalid Hospital</span>");
}
else
{
...
{
System.out.println("Here 1 is :"+dao);
System.out.println("Here 1 is :"+dao.getMessage());
}
PatientDTO patient=new PatientDTO();
patient.setName(name);
patient.setHospitalCode(hospitalCode);
patient.setGender(gender);
patient.setIsVaccinated(isVaccinated.equals("Y"));
patient.setDateOfBooking(dateOfBooking);
patient.setRegistrationAmount(registrationAmount);
...
pw.println("             <h2>Patient Added Successfilly<span>&#9989;</span>");
pw.println("</h2><br>");
HospitalDTO hospitalDTO=new HospitalDTO();
String patientId=patient.getPatientId();
pw.println( "<b><h1>"+patientId+"</b></h1><br>");
pw.println("                <tr>");
pw.println("                    <td>");
...
{
System.out.println("Here 2 is :"+dao.getMessage());
// recreate form with error message
}
}catch(IOException ioException)
{
System.out.println("Here 3 is :"+ioException.getMessage());
}catch(ParseException parseException)
{
System.out.println("Here 4 is :"+parseException.getMessage());
}
}
