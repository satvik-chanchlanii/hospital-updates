...
pw.println("                <span style='background-color: rgb(240, 15, 8) ;;'>Hospital (Delete Module)</h1>");
pw.println("");
pw.println("        <form method='post' action='/minor/deleteHospital'>");
pw.println("Hospital");
pw.println("      <br>");
pw.println( "<b>"+hospital.getHospitalName()+"</b><br><br>");
pw.println("<input type='hidden' id='hospitalNumber' name='hospitalNumber' value='"+hospitalNumber+"'><h1 style='color: #070707;'><span style='background-color: rgb(15, 206, 206); '> Are you sure you want to delete this Hospital ? </h1><br><br>");
